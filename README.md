...
출처는 공사가 지정한 형식으로 표기한다. 운영계정 승인 기준상 필수이며
...
공모전에서 제한하는 것은 **공사가 만들거나 운영하는 서비스로 오인시키는
표현**이며, 저작권 출처 표기는 그와 별개로 반드시 해야 한다. 이용약관에
"본 서비스는 한국관광공사가 개발하거나 운영하는 서비스가 아니다"를 명시해
둘을 구분한다.
